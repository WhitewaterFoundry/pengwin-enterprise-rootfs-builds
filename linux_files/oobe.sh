...
function main() {
  ...
  if [[ -z "${VERSION_X}" ]]; then
    echo 'Please create a root account password. This is the account used to perform administrative functions on Linux.'
